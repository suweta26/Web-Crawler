...
JLabel logLabe5 = new JLabel("contacts saved in:");
constraints = new GridBagConstraints();
constraints.anchor = GridBagConstraints.EAST;
constraints.insets = new Insets(5, 5, 0, 0);

layout.setConstraints(logLabel, constraints);
layout.setConstraints(logLabe5, constraints);
...
logTextField.setBackground(Color.YELLOW);
logTextField.setFont(new Font(logTextField.getFont().getName(),Font.BOLD,logTextField.getFont().getSize()));

//logTextField.setEnabled(false);
logTextField.setDisabledTextColor(Color.RED);
conTextField = new JTextField(file2);
conTextField.setBackground(Color.YELLOW);
//conTextField.setEnabled(false);
conTextField.setFont(new Font(conTextField.getFont().getName(),Font.BOLD,conTextField.getFont().getSize()));
conTextField.setDisabledTextColor(Color.RED);
...
layout.setConstraints(conTextField, constraints);
searchPanel.add(logTextField);
searchPanel.add(logLabe5);
searchPanel.add(conTextField);
...
fetchButton = new JButton ("fetch contacts");
...
layout.setConstraints(fetchButton, constraints);
...
if(flag==false)
matchesLabel1 = new JLabel("Search Matches:");
else
matchesLabel1 = new JLabel("Searching through:");
constraints = new GridBagConstraints();
constraints.anchor = GridBagConstraints.EAST;
...
JPanel matchesPanel = new JPanel();
 	matchesPanel.setBackground(Color.green);
...
private void actionSearch() {
	if(flag==true)
	{try{
links= conTextField.getText();
filen = new File(links);
writerr = new FileWriter(filen, true);
outputt = new PrintWriter(writerr);
conta = new StringBuffer();
}
catch(Exception ex){}
//}
	...
	//if(flag==true)
matchesLabel1.setText("fetching through");}
	else
matchesLabel1.setText("search matches");
...
//parse through page contents and retrive emails

public void retrieveEmails(URL pageUrl, String pageContents, HashSet crawledList,
boolean limitHost)
{	if(flag==true){
	//conta.append("bcd");
	//compile email matching pattern
...
if (pageContents != null && pageContents.length() > 0)
{
	...
	retrieveEmails(verifiedUrl, pageContents, crawledList,
limitHost);
